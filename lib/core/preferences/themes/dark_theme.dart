import 'package:clean_app/app/config.dart';
...
class DarkTheme {
  ...
  static Color secondaryColor = AppColors.blue;
  ...
  static Color dividerColor = AppColors.gray[900]!;
  static Color inputBackgroundColor = AppColors.black;
  static Color scaffoldColor = AppColors.black;
  static Color cardColor = AppColors.black;
  static Color appBarColor = AppColors.black;
